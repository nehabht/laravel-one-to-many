        ...
        <div class="col pe-5">
            <form action="" method="post" class="d-flex align-items-center">
                ...
                <div class="input-group mb-3 mt-3">
                    <input type="text" name="name" class="form-control" placeholder="Category name" aria-label="Recipient's username" aria-describedby="button-addon2">
            ...
            <table class="table table-striped table-inverse table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button form="category-{{$category->id}}" type="submit" class="btn btn-primary btn-sm text-white">Update</button>
                            <form action="{{route('admin.categories.destroy', $category->slug)}}" method="post">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger text-white btn-sm mt-1">Delete</button>
                            </form>
